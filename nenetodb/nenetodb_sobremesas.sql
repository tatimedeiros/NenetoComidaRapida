...
CREATE TABLE `sobremesas` (
  `sobremesa_id` int unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(40) DEFAULT NULL,
  `preço` double DEFAULT NULL,
  PRIMARY KEY (`sobremesa_id`)
...
INSERT INTO `sobremesas` VALUES (1,'Salada de Frutas Vermelhas 250 gramas',9.99),(2,'Brownie',2.39),(3,'Bolo Festa',3.59),(4,'Trufa de Chocolate com Maracujá',2.99);
